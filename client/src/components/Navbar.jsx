  ...
  return (
    <div className='shadow bg-white'>
        ...
        text-slate-800 transition-all'>
            ...
            <Link to="/app/interview-prep" className="flex items-center gap-2 text-gray-600 hover:text-green-600 transition">
                🎤 Interview Prep
            </Link>
           ...
           <Link to="/app/job-tracker" className="flex items-center gap-2 text-gray-600 hover:text-green-600 transition">
              📋 Job Tracker
          </Link>
