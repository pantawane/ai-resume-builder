  ...
  return (
    <div className='space-y-6'>
         <div className='flex items-center justify-between'>
            ...
            text-green-700 rounded-lg hover:bg-purple-200 transition-colors'>
                ...
                {data.map((experience, index)=> (
                    ...
                    space-y-3'>
                        ...
                        <div className='grid md:grid-cols-2 gap-3'>
                            ...
                            <input value={experience.start_date || ""} onChange={(e)=>updatedExperience(index, "position", e.target.value)}
                             type="month"  className='px-3 py-2 text-sm rounded-lg'/>

                             <input value={experience.end_date || ""} onChange={(e)=>updatedExperience(index, "end_date", e.target.value)}
                        ...
                        <div className='space-y-2'>
                            ...
                            <textarea value={experience.description || ""} onChange={(e)=> updatedExperience(index, "description", e.target.value)} rows={4} className='w-full text-sm px-3 py-2 rounded-lg
